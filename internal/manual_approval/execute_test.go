	...
	tests := []struct {
	...
	}{
		{
			...
			env: map[string]string{
				...
				"PAYLOAD":           "{\"status\":\"UPDATE_MANUAL_APPROVAL_STATUS_APPROVED\",\"comments\":\"test comments1\",\"userId\":\"123\",\"userName\":\"testUserName\",\"respondedOn\":\"2009-11-10T23:00:00Z\",\"inputs\": [{\"name\":\"reqBoolInput\",\"value\":true,\"is_default\":true},{\"name\":\"reqStrInput\",\"value\":\"strValue\",\"is_default\":true},{\"name\":\"reqNumInput\",\"value\":99.33,\"is_default\":false}]}",
			},
